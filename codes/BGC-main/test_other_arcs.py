...
parser.add_argument('--backdoor', type=bool, default=False)
parser.add_argument('--target_class', type=int, default=0)
parser.add_argument('--best_epoch', type=int, default=1000)
...
agent = Evaluator(data, args, device=f'cuda:{args.gpu_id}')
agent.train()
